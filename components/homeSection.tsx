        ...
        <div className="lg:px-20 2xl:container px-6">
            <div className="bg-bgColor rounded-2xl backdrop-filter backdrop-blur-lg bg-opacity-40 pt-8 pb-8 shadow-lg shadow-black/50">
                ...
                <div className="px-6">
                    <a className="text-blue-300 lg:text-xl text-md font-firaCode flex flex-wrap space-x-3 ">
                        <h1 className="pt-1 text-teal-500"><HiArrowNarrowRight /></h1>
                        <h1 className="font-firaCode font-semibold lg:text-xl text-md"><span className="text-blue-300 inline">ceres </span><span className="inline text-blue-800">git:(</span><span className="inline text-red-600">master</span><span className="text-blue-800">)</span> $ <span className="inline-block text-white">./about-we.sh</span></h1>
                    </a>    
                </div>
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-1/2 pt-5 px-6">
                        ...
                        <p className="font-firaCode text-sm lg:text-lg font-light text-white w-11/12">Ekstrakurikuler ini bertujuan untuk mengasah bakat dan minat siswa didalam bidang Infromatika dan teknologi seperti mempelajari bahasa pemograman, membuat website, E-Sport, membahas seputar teknologi dan komputer. Ekskul ini juga biasa dilakukan untuk persiapan olimpiade komputer nasional atau lomba-lomba seputar teknologi dan informatika.</p>
                    </div>
                </div>
            </div>
        </div>
